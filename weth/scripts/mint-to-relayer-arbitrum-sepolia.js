...
async function main() {
  console.log("💰 Minting WETH to relayer address on Arbitrum Sepolia...");
  ...
  const wethAddress = "0x333176b4F990e3C22c00a389281C9245B66bb4f8"; // Deployed WETH address on Arbitrum Sepolia
